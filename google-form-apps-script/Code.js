const CONFIG = {
  ...
  confirmationMessage:
    '신청이 접수되었습니다. 신청 내용 확인 후 등록 및 결제 안내를 순차적으로 드리겠습니다. 정원은 소수정예 기준으로 운영됩니다.',
  introLines: [
    '주력 강의 재설계 과정 신청서입니다.',
    '이 과정은 소수정예로 운영되며, 참가 신청 후 신청 내용 확인을 거쳐 등록 및 결제 안내를 드립니다.',
    '1차 신청 마감은 4월 20일이며, 잔여 좌석에 한해 4월 24일까지 추가 접수를 받습니다.',
